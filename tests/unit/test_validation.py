...
class TestInvoiceValidator:
    ...
    def test_validate_invoice_number_formats(self, validator):
        ...
        valid_numbers = ["INV-2024-001", "12345", "ABC123456", "2024/0001", "RE/240001"]

        for number in valid_numbers:
            assert validator._validate_invoice_number(number) is True

        invalid_numbers = ["", "12", "AB", None]
    ...
    def test_validate_financial_consistency(self, validator):
        ...
        consistent_data = {
            ...
            "invoice_lines": [{"line_total": 100.00, "quantity": 1.0, "unit_price": 100.00}],
        }
        ...
        inconsistent_data = {
            ...
            "invoice_lines": [
                {"line_total": 50.00, "quantity": 1.0, "unit_price": 50.00}  # Doesn't match total_excl_vat
            ],
        }
    ...
    def test_validate_dates(self, validator):
        ...
        # Test valid dates
        valid_data = {"issue_date": "2024-01-15", "payment_terms": {"payment_due_date": "2024-02-15"}}
        ...
        invalid_data = {
            ...
            "payment_terms": {"payment_due_date": "2024-01-01"},  # Before issue date
        }
        ...
        # Test future date
        future_data = {"issue_date": "2030-01-01"}  # Future date
    ...
    def test_validate_line_items(self, validator):
        ...
        valid_data = {
            "invoice_lines": [
                {"description": "Software License", "quantity": 2.0, "unit_price": 50.00, "line_total": 100.00}
            ]
        }
    ...
    def test_calculate_completeness_score(self, validator, valid_invoice_data):
        ...
        incomplete_data = {"invoice_id": "INV-001", "issue_date": "2024-01-15"}
    ...
    def test_calculate_confidence_score(self, validator, valid_invoice_data):
        ...
        data_with_metadata["processing_metadata"] = {"ocr_confidence": 0.95}
    ...
    def test_extract_pydantic_errors(self, validator):
        ...
        class MockPydanticError(Exception):
            def errors(self):
                return [
                    {"loc": ("invoice_id",), "msg": "field required", "input": None},
                    {"loc": ("supplier", "vat_id"), "msg": "invalid format", "input": "INVALID"},
                ]
